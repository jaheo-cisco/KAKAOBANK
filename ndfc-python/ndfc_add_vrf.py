...
if len(sys.argv) < 4:
    ...
    print("Example: python ndfc_add_vrf.py POC-FABRIC VRF-RED 50001 0 1 0")
    print("In this above example, VRF-RED will be created with L3 VNI 50001 enabling only host route to get advertised")
    sys.exit()
